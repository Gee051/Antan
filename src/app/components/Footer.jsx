    ...
    <footer className="bg-[#0b1a0bf3] text-white">
      <div className="max-w-screen-2xl mx-auto py-8 px-4 sm:px-8 md:flex md:justify-between md:items-center z-30">
        ...
        <div className="mb-4 md:w-1/2 lg:w-2/3 md:flex md:flex-col md:items-end">
          <div className="p-3">
            <p className="font-bold flex justify-end">NEWSLETTER</p>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 justify-end">
            <input
              ...
              className="bg-gray-700 text-white px-4 py-2 rounded-lg input w-full sm:w-auto"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
            />
            <button
              className="px-4 py-2 bg-green-500 text-white rounded-lg hover:scale-105 hover:transition cursor-pointer w-full sm:w-auto"
